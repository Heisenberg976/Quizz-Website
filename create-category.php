...
<div class="list-group" style = "float:left;margin-top:20px; width:200px">
  ...
  <a href="create-category.php" class="list-group-item list-group-item-action active">Categories</a>
  ...
  <div class="container">
    <a href="add.php" class = "btn btn-primary"style = "margin-top:20px;width:80px">Add</a>
...
<?php
        ...
        echo  '<div class="card" style = "margin-bottom:15px;width:18rem;">';
          echo '<img src="uploads/'. $res['image'] . ' " class="card-img-top" style = "height:200px">';
